...
public:
    ...
    LiMBinder(InstructionTable &instructionMap, CollectInfo &infoCollection, bool debugMode);
...
private:
    ...
    void performAccBinding(std::list<int*> accumulationList, std::string operation, std::list<std::string> specifications,  int * srcReg1, int * destReg, int ti);
