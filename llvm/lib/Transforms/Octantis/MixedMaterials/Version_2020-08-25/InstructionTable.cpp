...
void InstructionTable::AddInstructionToList(int * allocTime, int * lastModifTime, std::string op, int * destReg, int * src1Reg, int * src2Reg) {
...
void InstructionTable::AddInstructionToListAfterRefPos(int *refPos, int * allocTime, int * lastModifTime, std::string op, int * destReg, int * src1Reg, int * src2Reg){
...
void InstructionTable::AddAllocaInstructionToList(int * allocTime, int * destReg) {
...
bool InstructionTable::isParentValid(int * srcReg){
...
void InstructionTable::invalidateParent(int * parent){
...
std::list<InstructionTable::instructionData>::iterator InstructionTable::getIteratorToElement(int * position){
