...
///Class implementing the necessary structures to model the LiM Unit
    ...
    public:
        ...
        void addNewLiMRow(int *const &rowName, std::string &rowType, std::list<std::string> &addLogic, int &rowLength,
        ...
        bool
        changeLiMRowType(int *const &rowName, std::string &newRowType, std::list<std::string> &additionalOperators);
...
//----------------------------DEBUG FUNCTIONS---------------------------
    public:
        ...
        void printLiMArrayToFile(const int &par);
