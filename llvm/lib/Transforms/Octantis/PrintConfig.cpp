            ...
            if(line[0] != ';' && !(line.empty()))
            {
                if(line[0] == '[')
                {
                    ...
                    if(listIT != macroTypes.end())
                    {
                        ...
                        parsedData.insert(std::pair<std::string, std::map<std::string, std::list<std::string>>> (currentMacroType, tmpFieldMap));
                    ...
                    if(currentMacroType == "MemoryType"){
                        ...
                        if(listIT != fieldsMem.end())
                        {
                            ...
                            parsedData.find("MemoryType")->second.insert(std::pair<std::string, std::list<std::string>> (field, tmpValueList));
                            //errs() << "\t" << field << "\n";
                        }
                        ...
                        if(listIT != fieldsSyn.end())
                        {
                            ...
                            parsedData.find("SynthesisProcess")->second.insert(pair<string, list<string>> (field, tmpValueList));
                            //errs() << "\t" << field << "\n";
                        }
                        ...
                        if(listIT != fieldsAdv.end())
                        {
                            ...
                            parsedData.find("AdvancedLiMSettings")->second.insert(pair<string, list<string>> (field, tmpValueList));
                            //errs() << "\t" << field << "\n";
                        }
